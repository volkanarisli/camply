...
\subsection*{$\ast$$\ast$6.5.\+1$\ast$$\ast$}
...
\subsection*{$\ast$$\ast$6.5.\+0$\ast$$\ast$}
...
\item \mbox{[}Tests\mbox{]} up to {\ttfamily node} {\ttfamily v8.\+1}, {\ttfamily v7.\+10}, {\ttfamily v6.\+11}; npm v4.\+6 breaks on node $<$ v1; npm v5+ breaks on node $<$ v4
\item \mbox{[}Tests\mbox{]} add {\ttfamily editorconfig-\/tools}
\end{DoxyItemize}

\subsection*{$\ast$$\ast$6.4.\+0$\ast$$\ast$}
...
\subsection*{$\ast$$\ast$6.3.\+2$\ast$$\ast$}
...
\subsection*{$\ast$$\ast$6.2.\+3$\ast$$\ast$}
...
\subsection*{$\ast$$\ast$6.0.\+4$\ast$$\ast$}
