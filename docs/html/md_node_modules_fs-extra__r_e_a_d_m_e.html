...
<li>pathExistsSync</li>
<li>readJsonSync</li>
<li>removeSync</li>
<li>writeJsonSync</li>
</ul>
<p><b>NOTE:</b> You can still use the native Node.js methods. They are promisified and copied over to <code>fs-extra</code>. See notes on `fs.read()` &amp; `fs.write()`</p>
