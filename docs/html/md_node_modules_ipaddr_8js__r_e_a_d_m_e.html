...
<title>Camply: ipaddr.js — an IPv6 and IPv4 address manipulation library [![Build Status](https://travis-ci.org/whitequark/ipaddr.js.svg)](https://travis-ci.org/whitequark/ipaddr.js)</title>
...
<div class="fragment"><div class="line">var rangeList = {</div><div class="line">  documentationOnly: [ ipaddr.parse(&#39;2001:db8::&#39;), 32 ],</div><div class="line">  tunnelProviders: [</div><div class="line">    [ ipaddr.parse(&#39;2001:470::&#39;), 32 ], // he.net</div><div class="line">    [ ipaddr.parse(&#39;2001:5c0::&#39;), 32 ]  // freenet6</div><div class="line">  ]</div><div class="line">};</div><div class="line">ipaddr.subnetMatch(ipaddr.parse(&#39;2001:470:8:66::1&#39;), rangeList, &#39;unknown&#39;); // =&gt; &quot;tunnelProviders&quot;</div></div><!-- fragment --><p>The addresses can be converted to their byte representation with <code>toByteArray()</code>. (Actually, JavaScript mostly does not know about byte buffers. They are emulated with arrays of numbers, each in range of 0..255.)</p>
...
<div class="fragment"><div class="line">var addr = ipaddr.parse(&quot;2001:db8:10::1234:DEAD&quot;);</div><div class="line">addr.parts // =&gt; [0x2001, 0xdb8, 0x10, 0, 0, 0, 0x1234, 0xdead]</div></div><!-- fragment --><p>A IPv6 zone index can be accessed via <code>addr.zoneId</code>:</p>
<div class="fragment"><div class="line">var addr = ipaddr.parse(&quot;2001:db8::%eth0&quot;);</div><div class="line">addr.zoneId // =&gt; &#39;eth0&#39;</div></div><!-- fragment --><h4>IPv4 properties</h4>
...
<div class="fragment"><div class="line">ipaddr.IPv4.parse(&#39;255.255.255.240&#39;).prefixLengthFromSubnetMask() == 28</div><div class="line">ipaddr.IPv4.parse(&#39;255.192.164.0&#39;).prefixLengthFromSubnetMask()  == null</div></div><!-- fragment --><p><code>subnetMaskFromPrefixLength()</code> will return an IPv4 netmask for a valid CIDR prefix length.</p>
<div class="fragment"><div class="line">ipaddr.IPv4.subnetMaskFromPrefixLength(24) == &quot;255.255.255.0&quot;</div><div class="line">ipaddr.IPv4.subnetMaskFromPrefixLength(29) == &quot;255.255.255.248&quot;</div></div><!-- fragment --><p><code>broadcastAddressFromCIDR()</code> will return the broadcast address for a given IPv4 interface and netmask in CIDR notation. </p><div class="fragment"><div class="line">ipaddr.IPv4.broadcastAddressFromCIDR(&quot;172.0.0.1/24&quot;) == &quot;172.0.0.255&quot;</div></div><!-- fragment --><p> <code>networkAddressFromCIDR()</code> will return the network address for a given IPv4 interface and netmask in CIDR notation. </p><div class="fragment"><div class="line">ipaddr.IPv4.networkAddressFromCIDR(&quot;172.0.0.1/24&quot;) == &quot;172.0.0.0&quot;</div></div><!-- fragment --><h4>Conversion</h4>
